...
CREATE TABLE `orders` (
  ...
  KEY `ship_id_fk_idx` (`ShipID`),
  KEY `menu_id_idx` (`MenuID`),
  KEY `booking_id_idx` (`BookingID`),
  CONSTRAINT `booking_id` FOREIGN KEY (`BookingID`) REFERENCES `bookings` (`BookingId`),
  CONSTRAINT `customer_id_fk` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`CustomerID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `menu_id` FOREIGN KEY (`MenuID`) REFERENCES `menu` (`MenuID`),
  CONSTRAINT `ship_id_fk` FOREIGN KEY (`ShipID`) REFERENCES `deliverystatus` (`ShipID`)
...
-- Dump completed on 2023-03-01 12:57:19
...
CREATE TABLE `bookings` (
  ...
  CONSTRAINT `staffID` FOREIGN KEY (`StaffID`) REFERENCES `staff` (`StafID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-03-01 12:57:18
...
CREATE TABLE `customer` (
  ...
  `ContactNumber` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE `deliverystatus` (
  ...
  `ShipCost` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ShipID`),
  KEY `address_fk_idx` (`AddressID`),
  CONSTRAINT `address_fk` FOREIGN KEY (`AddressID`) REFERENCES `address` (`AddressID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
